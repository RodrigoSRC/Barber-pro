...
import { mdiReminder, mdiDelete, mdiPencil   } from '@mdi/js';
import CameraRetroIcon from '@rsuite/icons/legacy/CameraRetro';

import { useEffect, //*Icon*// 
  } from 'react';
          ...
          <div className="row mt-3">
            ...
            <div className="form-group col-12">
              ...
              <Uploader
                ...
                autoUpload={false}
                listType="picture"
                defaultFileList={servico.arquivos.map((s, index) => ({
                  name: s?.arquivo,
                  fileKey: index,
          ...
          <Table
            ...
            config={[
              ...
              },
              {
                ...
                sortable: true,
                width: 200,
                content: (dataCadastro) => moment(dataCadastro).format('DD/MM/YYYY'),
              },
              {
                label: 'Status',
                key: 'status',
